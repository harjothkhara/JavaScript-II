...
runners.forEach(function(currentValue) {
    let fornewarray = (currentValue.first_name+" "+currentValue.last_name);
    fullName.push(fornewarray);
  });
...
let firstUpper = runners.map(function(currentValue) {
    return currentValue.first_name.toUpperCase();
  });

  allCaps.push(firstUpper);
